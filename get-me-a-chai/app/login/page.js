...
const Login = () => {
    ...
    if (session) {
        return <p className="text-3xl text-center font-bold pt-10">Redirecting...</p>
    }

    return (
        <div className='text-white py-14 container w-3/4 mx-auto'>
            <h1 className="text-center font-bold text-3xl my-5">
                Login to Get Started
            </h1>

            <div className="flex flex-col gap-2 p-10 items-center my-10">

                <button
                    className="flex items-center w-64 gap-[10px] bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
